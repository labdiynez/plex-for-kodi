...
<control type="button" id="999">
    <animation effect="zoom" start="100" end="144" time="100" center="80,67.5" reversible="false">Focus</animation>
    <animation effect="zoom" start="144" end="100" time="100" center="80,67.5" reversible="false">UnFocus</animation>
    <posx>60</posx>
        ...
        <control type="list" id="2100">
            ...
            <focusedlayout width="240">
                <control type="group">
                    ...
                    <posy>{{ vscale(64) }}</posy>
                    <control type="group">
                        <animation effect="zoom" start="100" end="110" time="100" center="95,{{ vscale(140) }}" reversible="false">Focus</animation>
                        <animation effect="zoom" start="110" end="100" time="100" center="95,{{ vscale(140) }}" reversible="false">UnFocus</animation>
                        <posx>0</posx>
                        <posy>0</posy>
                        <control type="image">
        ...
        <control type="list" id="2101">
            ...
            <focusedlayout width="330">
                <control type="group">
                    ...
                    <posy>{{ vscale(64) }}</posy>
                    <control type="group">
                        <animation effect="zoom" start="100" end="110" time="100" center="140,{{ vscale(140) }}" reversible="false">Focus</animation>
                        <animation effect="zoom" start="110" end="100" time="100" center="140,{{ vscale(140) }}" reversible="false">UnFocus</animation>
                        <posx>0</posx>
                        <posy>0</posy>
                        <control type="image">
