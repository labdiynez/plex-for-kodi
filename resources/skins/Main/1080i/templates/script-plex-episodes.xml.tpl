...
<control type="group" id="50">
    <animation effect="slide" end="0,-125" time="200" tween="quadratic" easing="out" condition="!String.IsEmpty(Window.Property(on.extras))">Conditional</animation>
    ...
    {% block buttons %}
        ...
        <control type="grouplist" id="300">
            ...
            <posx>30</posx>
            <posy>{{ theme.episodes.buttongroup.posy }}</posy>
            <width>717</width>
            <height>200</height>
            <onup>200</onup>
            <ondown>400</ondown>
        ...
        <control type="grouplist" id="1300">
            ...
            <posx>30</posx>
            <posy>{{ theme.episodes.buttongroup_1300.posy }}</posy>
            <width>717</width>
            <height>200</height>
            <onup>200</onup>
            <ondown>400</ondown>
    ...
    <control type="group">
        ...
        <control type="group">
            ...
            <control type="group">
                <visible>!String.IsEmpty(Window.Property(use_alt_watched)) + !String.IsEmpty(Container(400).ListItem.Property(watched))</visible>
                <posx>667</posx>
                <posy>0</posy>
                <control type="image">
                    <posx>0</posx>
                    ...
                    <width>50</width>
                    <height>40</height>
                    <visible>String.IsEmpty(Window.Property(hide_aw_bg))</visible>
            ...
            <control type="list" id="401">
                ...
                <focusedlayout width="218">
                    <control type="group">
                        ...
                        <posy>29</posy>
                        <control type="group">
                            <animation effect="zoom" start="100" end="110" time="100" center="84,123" reversible="false">Focus</animation>
                            <animation effect="zoom" start="110" end="100" time="100" center="84,123" reversible="false">UnFocus</animation>
                            <posx>0</posx>
                            <posy>0</posy>
                            <control type="image">
